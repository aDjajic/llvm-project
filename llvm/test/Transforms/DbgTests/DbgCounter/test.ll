...
define dso_local noundef i32 @foo() local_unnamed_addr #0 !dbg !10 {
  tail call void @llvm.dbg.value(metadata i32 5, metadata !15, metadata !DIExpression()), !dbg !16
  ret i32 5, !dbg !17
}
...
3:                                                ; preds = %7, %2
  %4 = phi i32 [ %0, %2 ], [ %5, %7 ]
  %5 = phi i32 [ %1, %2 ], [ %8, %7 ]
  tail call void @llvm.dbg.value(metadata i32 %4, metadata !39, metadata !DIExpression()), !dbg !41
  tail call void @llvm.dbg.value(metadata i32 %5, metadata !40, metadata !DIExpression()), !dbg !41
